...
- ## Review a detected group deletion
	...
	- What you should see: the dock remains until you make an explicit choice, and then keeps the completed disposition visible as history. See [[tine-guide/Reference/Troubleshooting and recovery]] for the same steps in recovery form.
