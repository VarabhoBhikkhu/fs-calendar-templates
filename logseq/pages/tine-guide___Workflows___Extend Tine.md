...
- # Extend Tine
  - Add a plugin or a theme in a few minutes, know exactly what authority you granted, and take it back cleanly. This page is the hands-on path; the detailed rulebook stays on [[tine-guide/Features/Plugins]].
...
- ## Platform and distribution lines
  ...
  - Current public releases do not include an iOS app, and the iOS plugin host is not enabled. [[tine-guide/Reference/Platforms and mobile]] carries the full platform map.
- ## Where next
  - [[tine-guide/Features/Plugins]] keeps the detailed reference, including the safety-report fields and the cascade order — and links the authoring, packaging, and registry guide used by plugin developers.
