...
- ## Keep exploring
	...
	- [[tine-guide/Features/Quick capture]] — on desktop, drop a thought into your graph from **any** app with a global hotkey. (Set this one up — it's genuinely good.)
	...
	- [[tine-guide/Features/Managed sync]] — learn about the separate, opt-in, **known-buggy** mode for operation-backed sync that keeps your Markdown/Org graph in place.
